        ...
        <div className="flex  flex-col items-start gap-5 relative">
            ...
            <div className=" items-center xl:items-start gap-3 md:gap-14   flex flex-col md:flex-row relative">
                <div className="flex-col items-start gap-[16px] flex-[0_0_auto]  flex  justify-center md:py-5 relative">
                    ...
                    <Image
                        className="relative w-[200px] h-[230px] mt-[-4.00px] mb-[-12.00px] mr-[-8.00px] rounded-xl  self-center "
                        alt="Group"
                        src={Author.imageUrl}
                ...
                <div className="flex-col items-start gap-10   inline-flex relative  text-sm sm:text-md md:text-lg text-justify  ">
                    ...
                    <a href={Author.linkdInUrl} className="h-[77px] items-center justify-center gap-[13px] px-[35px] py-[24px] bg-[#e0e4ef] rounded-[16px] overflow-hidden inline-flex relative">
                        ...
                        <div className="relative w-fit mt-[-1.00px]  font-normal text-black  text-xl md:text-2xl">
                            Connect with me
                        </div>
                    </a>
                </div>
