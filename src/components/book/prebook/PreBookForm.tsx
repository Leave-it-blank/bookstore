export default function form({ setModelState }: any) {
    return (
        <>   <div className="absolute inset-0  z-50 border rounded-xl ">

            <div className="  max-w-2xl mx-auto bg-white flex flex-col items-center justify-center p-5 ">
                <button className="self-end" onClick={() => setModelState(false)}  >  X </button>
