...
const Footer: React.FC = () => {
    return (
        <div className='w-full  py-5 bg-black pb-10 px-3 md:px-10 '>
            <div className="  container mx-auto justify-between items-center flex  ">
                <div className=' flex flex-col gap-3'>


                    <div className="flex-col justify-start items-start  gap-1 md:gap-3 inline-flex  self-start">
                ...
                <div className="flex-col justify-start text-xs sm:text-lg  items-end gap-1 inline-flex self-start">
